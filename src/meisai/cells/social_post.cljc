(ns meisai.cells.social-post.state-machine
  "Phase state machine for the 明細 — Member Card-Statement Ingestion social_post cell — the publication membrane that
